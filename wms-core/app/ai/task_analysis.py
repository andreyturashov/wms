    ...
    def _generate(
        ...
        **kwargs,
        ...
        if "# Executor Agent" in system_text:
            response = (
                "The described work is well-scoped and can be addressed directly.\n\n"
                "Based on the task requirements, the recommended approach is to\n"
                "implement the changes incrementally with proper test coverage.\n\n"
                "**Assumptions**: The existing codebase supports the requested change\n"
            ...
            response = (
                "**Key Insight**\n\n"
                "The task is straightforward but has room for improvement.\n\n"
                "**Ideas & Alternatives**\n\n"
                "1. Direct implementation - fast, minimal risk.\n"
                "2. Broader refactor - higher quality, longer timeline.\n\n"
                "**Watch Out For**\n\n"
