...
class MockLLM(BaseChatModel):
    ...
    def _generate(
        ...
        **kwargs,
        ...
        if "Executor" in system_text:
            response = (
                "**Execution Plan**\n\n"
                "1. Analyse the requirements described in the task.\n"
                "2. Implement the changes in the codebase.\n"
                "3. Write tests to cover the new behaviour.\n\n"
                "**Prerequisites**: None.\n\n"
                "**Estimated Total Effort**: Small to medium.\n\n"
                "**Risks / Blockers**: None detected.\n\n"
                "_Generated by Executor Agent._"
            )
        elif "Thinker" in system_text:
            response = (
                "**Problem Analysis**\n\n"
                "The task appears well-scoped.\n\n"
                "**Proposed Approaches**\n\n"
                "1. Straightforward implementation - low risk, fast delivery.\n"
                "2. Refactor first, then implement - higher quality, longer timeline.\n\n"
                "**Recommendation**: Approach 1 for speed.\n\n"
                "**Open Questions**: None at this time.\n\n"
                "_Generated by Thinker Agent._"
            )
        else:
            response = (
                "**AI Analysis**\n\n"
                ...
                "_This analysis was generated automatically._"
            )
...
def build_prompt(state: TaskAnalysisState) -> TaskAnalysisState:
    ...
    prompt = (
        ...
        f"Please analyse this task according to your role and guidelines."
    )
